# This is a training script for conditional generation to be run in a distributed manner on a DGX Station with x gpus
...
lr = 1.25e-4
save_dir = 'results/run_conditional_t1_t2'
